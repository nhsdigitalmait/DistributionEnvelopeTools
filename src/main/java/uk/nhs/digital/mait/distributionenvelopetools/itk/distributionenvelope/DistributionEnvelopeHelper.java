 ...
 */
// $Id: DistributionEnvelopeHelper.java 30 2016-02-23 13:42:56Z sfarrow $
...
public class DistributionEnvelopeHelper {
    ...
    /**
     * @return Singleton DistributionEnvelopeHelper
     ...
     * 
     * @param d distribution envelope
     * @return Array of Payload instances
     * @throws java.lang.Exception
     */     
     ...
     * @param s
     * @return the DistributionEnvelope
     * @throws java.lang.Exception 
     */     
    ...
    */    
            ...
            throws Exception
    {
        ...
        ArrayList<Identity> audit = new ArrayList<>();
        Address sender = null;
        for (String l : lines) {
