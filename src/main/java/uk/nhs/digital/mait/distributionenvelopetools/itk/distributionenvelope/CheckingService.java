 ...
 */
// $Id: CheckingService.java 30 2016-02-23 13:42:56Z sfarrow $
 ...
 * 
 * <code>uk.nhs.digital.mait.itk.distributionenvelope.checkerlist</code>
 * 
 * containing a space-delimited list of "checker names". Then for each name, create a property:
 * 
 * <code>uk.nhs.digital.mait.itk.distributionenvelope.checker.{checker name}</code>
 * 
...
public class CheckingService {
     ...
     */
    private static final String CHECKERS =  "uk.nhs.digital.mait.itk.distributionenvelope.checkerlist";
    private static final String CHECKROOT = "uk.nhs.digital.mait.itk.distributionenvelope.checker.";
     ...
     * must be a class that can be case to uk.nhs.digital.mait.itk.DistributionEnvelope.DistributionEnvelopeChecker
     * 
            ...
            throws Exception
    {
        ...
        if (checks.containsKey(s)) {
            ...
            ArrayList<DistributionEnvelopeChecker> a = new ArrayList<>();
            a.add(chk);
            checks.put(s, a);
        }
    }
